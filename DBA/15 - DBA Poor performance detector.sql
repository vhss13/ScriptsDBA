...
,rs.max_target_memory_kb --Maximum pot56ential target in kilobytes. NULL for the small-query resource semaphore.
...
--Total number of time-out errors since server start up. NULL for the small-query resource semaphore.
...
CROSS APPLY sys.dm_exec_query_plan (r.plan_Handle) ph

order by mg.query_cost desc
