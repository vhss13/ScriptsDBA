...
BEGIN
	...
	where 
		...
		begin
			...
			set @Nm_Caminho = 'C:\Users\vsilva\Downloads\ARQ_DBA\' + @Nm_Database+ '_'+(CASE DATEPART(w, GETDATE()) 
							WHEN 1 THEN 'Domingo'
							WHEN 2 THEN 'Segunda'
							WHEN 3 THEN 'Terca'
							WHEN 4 THEN 'Quarta'
			...
			--set @Nm_Caminho = 'C:\Users\vsilva\Downloads\ARQ_DBA\' + @Nm_Database + '.bak'
			
			exec DBA_MON.dbo.stpBackup_FULL_Database @Nm_Caminho, @Nm_Database, @Nm_Caminho --o último parametro corresponde a descrição do bkp
